...
class DeepSearchAgent:
    ...
    def _initialize_llm(self) -> LLMClient:
        """初始化LLM客户端"""
        return LLMClient(
            api_key=(self.config.MEDIA_ENGINE_API_KEY or self.config.SENTINEL_SPIDER_API_KEY),
            model_name=(self.config.MEDIA_ENGINE_MODEL_NAME or self.config.SENTINEL_SPIDER_MODEL_NAME),
            base_url=(self.config.MEDIA_ENGINE_BASE_URL or self.config.SENTINEL_SPIDER_BASE_URL),
        )
